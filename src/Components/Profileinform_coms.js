...
const Profileform = () => {
  ...
  return (
    <>
       <div className="relative bg-gray-100 pb-20 pt-24  lg:pb-24 h-screen w-screen">
      ...
      <div className="mt-6 border-t border-gray-100">
        <dl className="divide-y divide-gray-100">
          ...
          <button className='rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline'>
